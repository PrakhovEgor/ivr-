...
class TestApp(unittest.TestCase):
    ...
    def test_transform_period(self):
        corr_input = [{'id': 2, 'email': 'egor.prakhov@mail.ru', 'name': 'Напоминание', 'm_type': '-', 'tg_id': ['1'],
                       'plants': [], 'start_date': '2023-11-06T22:00', 'period': '1_day', 'comment': '',
                       'plants_ids': []}]
        corr_output = [{'id': 2, 'email': 'egor.prakhov@mail.ru', 'name': 'Напоминание', 'm_type': '-', 'tg_id': ['1'],
                        'plants': [], 'start_date': '2023-11-06T22:00', 'period': 'каждый день', 'comment': '',
                        'plants_ids': []}]
